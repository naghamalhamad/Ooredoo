  ...
  return (
    <label className="block">
      ...
      <input
        ...
        className="w-full rounded-lg border border-gray-200 px-3 py-2.5 text-sm font-semibold text-gray-900 placeholder:font-semibold placeholder:text-gray-900 focus:border-rose-400 focus:outline-none"
      />
    </label>
  )
}
  ...
  return (
    <label className="block">
      ...
      <div className="relative">
        <select
          defaultValue=""
          className="w-full appearance-none rounded-lg border border-gray-200 bg-transparent px-3 py-2.5 text-sm font-semibold text-gray-900 focus:border-rose-400 focus:outline-none"
        >
    ...
    <label className="block">
      ...
      <div className="relative">
        <input
          type="text"
          defaultValue={value}
          className="w-full rounded-lg border border-gray-200 px-3 py-2.5 text-sm font-semibold text-gray-900 focus:border-rose-400 focus:outline-none"
        />
