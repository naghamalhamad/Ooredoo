...
function KpiChartCard({ title, mtd, lmtd }: { title: string; mtd: number; lmtd: number }) {
  return (
    <div className="flex-1 rounded-[8px] bg-gray-50 p-3">
...
function LinkRow({ icon, label }: { icon: IconName; label: string }) {
  return (
    <button
      type="button"
      className="flex w-full items-center gap-3 rounded-[8px] bg-gray-50 px-3 py-3 hover:bg-gray-100 active:bg-gray-200 transition-colors"
    >
